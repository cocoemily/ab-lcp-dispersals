...
to setup
  ...
  if output? [
    ...
    set file-2 (word "/home/ec3307/ab-lcp-dispersals/outputs/parallel-tests/" "LIST_outputs_path_" origin "_" time-period "_" levy_mu "_" patch-size-km "_" stamp1 ".csv")
    ;output-print file-1
    output-print file-2
...
@#$#@#$#@
<experiments>
  <experiment name="test_parallel" repetitions="5" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
